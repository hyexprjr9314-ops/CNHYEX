...
const pushApi = fs.readFileSync(new URL('../api/push-notifications.js', import.meta.url), 'utf8');
const pushHelper = fs.readFileSync(new URL('../api/_push.js', import.meta.url), 'utf8');
